...
{
    class ColorSimilarityCalculatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/colorsimilarity";

        /// <summary>
        /// Make a GET request to the Color Similarity Calculator API
        /// </summary>
        static async Task<JsonDocument> CallColorSimilarityCalculatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;color1&quot;] &#x3D; &quot;FF5733&quot;, [&quot;color2&quot;] &#x3D; &quot;FF6B47&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Color Similarity Calculator API...\n");

            var result = await CallColorSimilarityCalculatorAPI();
