...
const (
	baseURL        = "https://api.apiverve.com/v1/colorsimilarity"
	defaultTimeout = 30 * time.Second
)

// Client is the Color Similarity Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Color Similarity Calculator API client.
...
// Execute makes a request to the Color Similarity Calculator API with typed parameters.
//
