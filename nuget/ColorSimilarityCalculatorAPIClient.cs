...
namespace APIVerve.API.ColorSimilarityCalculator
{
    ...
    /// <summary>
    /// Client for the ColorSimilarityCalculator API
    /// </summary>
    public class ColorSimilarityCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/colorsimilarity";
        ...
        {
            { "color1", new ValidationRule { Type = "string", Required = true, Format = "hexColor" } },
            { "color2", new ValidationRule { Type = "string", Required = true, Format = "hexColor" } }
        };
        ...
        public ColorSimilarityCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorSimilarityCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorSimilarityCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ColorSimilarityCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ColorSimilarityCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ColorSimilarityCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ColorSimilarityCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ColorSimilarityCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ColorSimilarityCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ColorSimilarityCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ColorSimilarityCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ColorSimilarityCalculatorQueryOptions options)
        {
