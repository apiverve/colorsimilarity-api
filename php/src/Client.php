...
namespace APIVerve\Colorsimilarity;
...
/**
 * Client for the Color Similarity Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/colorsimilarity?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/colorsimilarity';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ColorsimilarityClient] {$message}\n";
        }
    }
}
