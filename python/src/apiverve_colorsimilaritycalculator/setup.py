...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/colorsimilarity',
        'Source': 'https://github.com/apiverve/colorsimilarity-api',
        'Bug Tracker': 'https://github.com/apiverve/colorsimilarity-api/issues'
    },
    classifiers=[
