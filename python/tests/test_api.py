...
class TestColorsimilarityAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ColorsimilarityAPIClient(self.api_key)

    @patch('apiverve_colorsimilaritycalculator.apiClient.requests.get')
